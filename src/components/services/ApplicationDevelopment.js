...
export default function ({classes}) {
    return (
        <>
                      <Box flex='6'    minHeight='400px' borderRight='2px solid black'>
                <Box position='relative' style={{paddingTop:'80px',paddingRight:'32px'}} height='100%'>
                    <div className={classes.bg}  style={{backgroundImage:'url("assets/img/home.jpg")',
              backgroundPosition:'center center',
              objectfit:'contain',
              height:'100%',
              width:'100%',
              backgroundSize:'cover'}}/>
              <Box bgColor='#FFFFF' zIndex='2' position='absolute' top={'80px'} right={'-12px'}>
                ...
                <Box flex='6' >
                   ...
                   <Typography color='' style={{textAlign:'justify'}}> In today’s world of technology, it is essential for every business to 
